...
func Getsave() (*Character) {
	...
	chara.st.dmg = get_line_int(string(data), 6)
	chara.st.dmg_emp = get_line_int(string(data), 7)
	chara.st.taken_emp = get_line_int(string(data), 8)
	chara.st.luck = get_line_int(string(data), 9)

	chara.inventaire.potion = get_line_int(string(data), 10)
	chara.inventaire.potion_poison = get_line_int(string(data), 11)
	chara.inventaire.piece_or = get_line_int(string(data), 12)

	chara.inventaire.Plume_de_Corbeau = get_line_int(string(data), 13)
	chara.inventaire.Cuir_de_Sanglier = get_line_int(string(data), 14)
	chara.inventaire.Fourrure_de_loup = get_line_int(string(data), 15)
	chara.inventaire.Peau_de_Troll = get_line_int(string(data), 16)

	chara.inventaire.Chapeau_de_l_aventurier = get_line_int(string(data), 17)
