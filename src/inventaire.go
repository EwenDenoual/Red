...
func initInventory() Inventory {
	...
	inventaire_player1.potion_mana = 0
...
func DisplayInventory(player1 Character) Character {
	fmt.Printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
	fmt.Printf("\n-------------------- Inventaire : -----------------------------\nPotion = %v\nPotion Mana = %v\nPiece Or = %v\nPlume De Corbeau = %v\nCuir De Sanglier = %v\nFourrure De Loup = %v\nPeau De Troll = %v\nChapeau De L'Aventurier = %v\nTunique De L'aventurier = %v\nBottes De L'Aventurier = %v\n---------------------------------------------------------------\n\n", player1.inventaire.potion,player1.inventaire.potion_mana, player1.inventaire.piece_or, player1.inventaire.Plume_de_Corbeau, player1.inventaire.Cuir_de_Sanglier, player1.inventaire.Fourrure_de_loup, player1.inventaire.Peau_de_Troll, player1.inventaire.Chapeau_de_l_aventurier, player1.inventaire.Tunique_de_l_aventurier, player1.inventaire.Bottes_de_l_aventurier)
...
func TakePot(player1 Character) Character {
	if player1.pv >= player1.pv_max {
		fmt.Printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nVos PV sont au maximum, vous ne pouvez pas utiliser de potion de vie\n")
	} else {
...
func PoisonPot(player1 Character) Character {
	player1.pv -= 10
	fmt.Printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nVous venez de recevoir une potion de poison, voici vos PV : %v sur %v \n", player1.pv, player1.pv_max)
...
func Potion_mana(player1 Character) Character {

	if player1.inventaire.potion_mana > 0 {
		player1.inventaire.potion_mana -= 1
		player1.mana += 30
		fmt.Printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nVous disposez de %v mana\n", player1.mana)

	} else {
		fmt.Printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nVous ne disposez pas de potion de mana dans votre inventaire.\n")
	}
	return player1
}
...
func Menu_objet(player1 Character) Character {
	var i int
	Printfct("Quel objet voulez vous utiliser : \n\n1: Potion de vie \n2: Potion de poison\n3: Potion de Mana\n\n0: Retour", 30, 4)
	for {
		fmt.Scanln(&i)
		switch i {
		case 0:
		...
		case 1:
			...
			return player1
		case 2:
			player1 = PoisonPot(player1)
			return player1
		case 3:
			player1 = Potion_mana(player1)
			return player1
		default:
			println("invalid")
		}
